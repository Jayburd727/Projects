...
def calculateIntersectPoint(p1, p2, p3, p4):
    ...
    if p is not None:
        p = p[0]
        if between(p[0], p1[0], p2[0]) and between(p[1], p1[1], p2[1]) and between(p[0], p3[0], p4[0]) and between(p[1],
                                                                                                                   p3[
                                                                                                                       1],
                                                                                                                   p4[
                                                                                                                       1]):
        ...
        if result != None:
            ...
            if matchingPoint is not None:
                if matchingPoint[0] in intersectEndPoints:
                    ...
                    if calculateIntersectPoint(point, outsidePoint, intersectEndPoints[matchingPoint[0]],
                                               matchingPoint[1]) is not None:
                        continue
                else:
